...
from utility.create_weather_data import (
    create_weather_data_proto,
    create_weather_data_simple,
)
...
if __name__ == "__main__":
    ...
    process_weather_data(
        input_csv_file, output_binary_file, process_all=(args.mode == "test")
    )
